...
我们下面要了解Thonny的使用了，打开Thonny：在最上面可以看有：File、Edit、View、Run、Tools、Help。
...
前42个实验我们将42款传感器利用我们套件中的杜邦线，单独连接在Raspberry Pi Pico板和Raspberry Pi Pico扩展板。然后运行对应的测试代码，单独测试各个传感器的功能。

后20个实验将多个传感器/模块搭配使用，组合出各种各样的功能。传感器/模块种类比较多，我们只是选择几款比较经典的组合实验。你们也可以根据自己的想法，自己设置代码，组合出你想要的特别的功能。
...
![](media/1221d23876abe475edd35fc8b6d90004.png)
...
![](media/33b6a6e15bac7da21f4eb3ef9e7f5b8c.png)
...
![](media/986d847bbbdf73a772128f85a43cb67e.png)
...
![](media/edcea78b227503ed74d7af5e18786ed8.png)
...
![](media/9ba1e4d8413974e9f9059a57952ed3c3.png)
...
![](media/9cb8d15cd25d6402d2d7685e307f86a6.png)
...
![](media/9e86493db75e51cfb292bab6c6602520.png)
...
![](media/064a0e0e8107548c89aace0ec9218df7.png)
...
![](media/ee83115b37e74f8a7ff9986792275cab.png)
...
![](media/8db851b3c3c2d42c6fa0b710ea25de9e.png)
...
找到collision sensor.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/4a26010f3f7d6a3f1ca50fc95b92dacb.png)

代码说明：

代码设置与实验九相同，详情请看代码注释与实验九代码说明。

实验结果：

运行测试代码，shell显示对应数据和字符。实验中，传感器上弹片下压时，val为0，模块红色LED点亮，打印“The end of his!”字符；当松开弹片时，val为1，模块红色LED熄灭，打印“All going well!”字符。
...
![](media/9bbf374369f0f4340dc796229885db51.png)
...
![](media/af0aef55ac55b8dea8f7cf87a3953e58.png)
...
![](media/0b105f7ce5a2900f0bdb62abb9bb24eb.png)
...
![](media/8f78d64bb8be2c4f12c14ad4c667d64b.png)
...
![](media/9dc9de506c8ce9f42c6dc31bad935ef0.png)
...
![](media/e415f50b5df559ea79540bab445973fa.png)
...
那么我们这个实验就是要通过调节3个PWM值，控制LED元件显示红光、绿光和蓝光的比例，从而控制RGB模块上LED显示不同颜色灯光。当设置的PWM值越大，对应显示的颜色比例越重。理论上来说，通过调节这3中颜色光的混合比例，可以模拟出所有颜色的灯光。![](media/14ee88711379bb957124c3c84911af79.png)
...
![](media/f5295afa4131e0a1d9eac4d0443119e1.png)
...
### 实验18：旋转电位器 ![](media/fe92a4f36758bc236d94290478fe5eac.jpeg)
...
![](media/de1048e6d9bef29d3e763800a378c16d.png)
...
![](media/74647b5ae4542bbd77f8f89ddfef4982.png)
...
![](media/c5d559aca3708794e43d189c15b92fbf.png)
...
![](media/160dbb8d655328016c326894dda22759.png)

代码说明：

设置方法和实验八类似，这里用到ADC(28)即通道2：ADC(2)。这里就不多做介绍了。
...
![](media/663029ce42c919413ed3f67e896ac3f2.png)

代码说明：

设置方法和实验八类似，只是这里我们用ADC(0)，也就是ADC(26)。
...
![](media/0f7f498aba62e3965bc91cb7181e324e.png)
...
![](media/ce1f4bccc236ed13eb461351b43dd5e7.png)
...
![](media/7bbab04d7dca3775a4b1e5156c69f770.png)

代码说明：

参考实验二十四，设置两个管脚的接口，并将测试结果在shell上显示。
...
找到MQ-3.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/0e91a89ea86c8d260033fdaf3af711ff.png)

代码说明：

参考实验二十五，设置两个管脚的接口，并将测试结果在shell上显示。
...
找到AD key.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/022e33db3de982e62745dfd78a5aeb2c.png)
...
![](media/c76baf3c8006e86a3a71634a89580eb0.png)
...
![](media/698a4b7bf0f2530f40e7bad1e0f58e18.png)
...
运行测试代码后，shell显示对应紫外线模拟值数据。阳光照射紫外线模块时，我们可以看到数据值也有一些明显的变化，如下图。
...
![](media/414d0ccd16a4fea550376770c0693094.png)
...
![](media/f0e1ff1872c2d5802d6fe151af087ff0.png)
...
![](media/d1f2f6854fc324bdd5fea60f8371bd21.png)
...
![](media/a329dc695443a9bcabad33baf9493756.png)
...
![](media/5374c0366b5c4c1d5a1b6f994a88ac79.png)
...
![](media/98f7920bbcacc4db418f2a5740e0046f.png)
...
我们保存完之后，可以在左侧文件区的pico下方看到，然后我们再次运行ds18b20.py，这时就可以正常运行了

![](media/a3890642c4d31b228d17adcd2e67fdfe.png)

![](media/a25faee9cb146df3a1135da24e61b643.png)
...
![](media/cdfee1f011c3ae4e844d19ad82141e5a.png)

然后找到XHT11.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/25014e17571e2dd4ad8103032efa1005.png)
...
![](media/8a7647d386d4e52546c6b8528c570433.png)

然后我们再来运行DS1307.py：

![](media/23e6207b3f2c10d0fb982f35caa5d7d7.png)
...
![](media/469541ebff537a2d734f75f6ab59b6af.jpeg)ADXL345是一款完整的3轴加速度测量系统，可选择的测量范围有±2 g，±4 g，±8 g或±16 g。它数字输出数据为16位二进制补码格式，可通过SPI（3线或4线）或I2C数字接口访问。该传感器可以在倾斜检测应用中测量静态重力加速度，还可以测量运动或冲击导致的动态加速度。其高分辨率(3.9mg/LSB)，能够测量不到1.0°的倾斜角度变化。
...
![](media/242484c1428cab93af91f742f4fa490a.png)

然后我们再来运行adxl345_test.py：

![](media/2fec20fcd543206603534dd1acf9384e.png)
...
运行测试代码，观察shell。shell显示三轴加速度对应的值，单位为mg
...
![](media/865937cd868c339ede8da83b644c72cb.png)
...
![](media/5451aed32bc5b7b30fbd5613ad09a65b.png)实验原理：
...
![](media/0c27ad2e9d29ff15682ba612d5d5510b.png)

然后我们在我们保存的代码路径中找到LCD 128\*32.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/d6e68b427367cdb6821d901fb6c630ca.png)

代码说明：

scan_for_devices()这个函数为IIC寻址函数；如果识别到了IIC器件，则打印出器件的IIC地址，如图：
...
lcd.Cursor(0, 7)为设置光标函数，即设置字符在lcd显示的位置，第一个参数为行的参数，第二个为列的参数，那么这里表示为，第一行，第七列开始显示字符

lcd.Display("KEYES")为设置要显示的字符内容，这里显示”KEYES”
...
找到mfrc522.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/8c7870df37c15ae2b8e714f1858559db.png)

保存完之后，我们就可以看到在mycropython device
下也就是pico中我们保存的模块

![](media/45c2febbdb7a6678c467d42ee8d30ce0.png)
...
![](media/9f9100ba8cdca297329c799eafc0d485.png)
...
![](media/a80f2d67672d34020a0efe1538641452.png)
...
![](media/74d4f843ddc976617ef3e13c797220b4.png)
...
![](media/1181495a3e12919c1ee0249cd5c78c26.png)
...
![](media/5f2b4bada8f05a6fba401e9ef5f87ced.png)

代码说明：

前面实验四十四我们使用到了中断，sensor_pir.irq(trigger=machine.Pin.IRQ_RISING, handler=pir_handler)同样我们这个实验中也用到了中断，只是触发方式与前面相反，这里是上升沿触发，即低电平变为高电平触发，pir_handler为中断服务函数，使蜂鸣器响起，LED快速闪烁。
...
![](media/d0d92a106ad8f42954976f5bf1b1dbe2.png)
...
找到Self-extinguishing.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/11f79b62e53401575058d9f4cd15245f.png)
...
![](media/f4f81bfd326d8672e5365933ff253866.png)
...
![](media/49f531774c7a127648cebfe4df795977.png)
...
|![](media/c4bec8956b5785f9b6c98b310e182d18.png)|![](media/b9233c67c93c243214388d668afe2eab.png)|![](media/c42e614c0f21cf8487b9800c00091955.png)|![](media/b9a96e60ed3aee985db5d4dcaf9bf38b.png)|![](media/08c4fccd202b5ab71707eb13653c6bd5.jpeg)|![](media/edbfec59fe015bd9987e4b4d542b466d.png)|
|-|-|-|-|-|-|
...
![](media/327309ed6d3b23fcbcb118574bcc4a16.png)
...
![](media/a7858ed0869a7759af5ca7253553c233.png)
...
![](media/57d791bb98e0eaeaa5400e373364dede.png)

代码说明：

实验中代码设置和前面实验类似，是设置一个模拟值的阈值，达到这个阈值进行点亮或者熄灭LED，在前面单个传感器模块中我们学到，这个火焰传感器有使用到一个模拟管脚和一个数字管脚，当检测到火焰时，数字管脚输出低电平。前面我们使用到模拟口，这个实验我们就使用数字口。
...
![](media/6898f106c8f663a93aed53655a3e62c9.png)
...
找到breathalyzer.py，然后双击打开代码，再点击![](media/d1dbbae869194ef12c2d684636f1ce4b.png)运行代码

![](media/41a76490e177cf9a583131200a75ce97.png)
...
![](media/8bb6084baf434a8fb0cc515223b30f15.png)
...
![](media/d3b4b69161aba4cdab32722fadbbc445.png)
...
![](media/408dc77a39a9df2f7c16bfc45cbdc621.png)
...
![](media/0d8fb1048b5c3dc60077325b466b1aa8.png)
...
![](media/fe6929b85e41c40e73f2ec29abc7e325.png)
...
![](media/e4423f2df5815915eb31b6e0821b7ac7.png)

代码说明：

设置时，我们参考本章节实验四十四方法。利用按键中断计算出按下按键的次数，除以8，得到余数，为0 1 2 3 4 5 6 7，根据不同的余数，构造8个独一的函数来控制实验实现不同功能。

参照介绍方法，我们可以在接线中添加或减少传感器/模块，然后在代码中更改实验功能。

我们这个课程需要添加dht和adxl345库文件
